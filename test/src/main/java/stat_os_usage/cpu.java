...
//        System.out.println("cpu占有率2=" + c.getCpuRatioForWindows());
        ...
        System.out.println("可使用内存=" + monitorInfo.getTotalMemory() / 1024);
        System.out.println("剩余内存=" + monitorInfo.getFreeMemory() / 1024);
        System.out.println("最大可使用内存=" + monitorInfo.getMaxMemory() / 1024);

        System.out.println("操作系统=" + monitorInfo.getOsName());
        System.out.println("总的物理内存=" + monitorInfo.getTotalMemorySize() / 1024 + "mb");
        System.out.println("剩余的物理内存=" + monitorInfo.getFreeMemory() / 1024 + "mb");
        System.out.println("已使用的物理内存=" + monitorInfo.getUsedMemory() / 1024 + "mb");
