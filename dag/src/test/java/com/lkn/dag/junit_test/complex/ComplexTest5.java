 ...
 */
public class ComplexTest5 extends BaseTest {
    ...
    */
    ...
    public void test2() {
        ...
        Assert.assertTrue(isAfter(Global.records, "B1-0", "B2-0"));
        Assert.assertTrue(isAfter(Global.records, "A1-10001,A2-10001,A3-10001,A4-10001", "A1-10002,A2-10002,A3-10002,A4-10002"));
        Assert.assertTrue(isAfter(Global.records, "A1-10002,A2-10002,A3-10002,A4-10002", "A1-10003,A2-10003,A3-10003,A4-10003"));
        ...
        Assert.assertTrue(isAfter(Global.records, "A5-10001,A6-10001", "A5-10002,A6-10002"));
        Assert.assertTrue(isAfter(Global.records, "A5-10002,A6-10002", "A5-10003,A6-10003"));
